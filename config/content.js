window.USTI_CONFIG = {
  ...
  results: [
    ...
    },
    {
      ...
      portrait: "班级群潜水常客，课堂低调坐角落，平时行踪飘忽不定。不爱凑热闹、不主动社交，存在感不高但极具个人节奏。看似冷冷清清，实则内心通透清醒，按自己的节奏享受大学生活，安静蓄力，悄悄优秀。",
    ...
    },
    {
      ...
      portrait: "用实力说话，全系公认的万能大腿，只要有你在，小组作业、课程展示、竞赛项目直接稳了。执行力强、实力能打、从不甩锅。在学习与合作中，带着大家一起进步，是全员争相抱紧的靠谱战神。努力就是雕塑自己，今天的自己比昨天更强了呢！",
    ...
    },
    {
      ...
      portrait: "正值青春年华，却拥有三四十岁的成熟心态。看透内卷套路，拒绝无谓焦虑，不跟风内耗、不盲目攀比。待人处事稳重通透，情绪极度稳定，比同龄人更清醒、更克制，是大学里少见的“早熟型”通透选手。",
      slogan: "清醒自持，步履从容。",
